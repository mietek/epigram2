...
> data Elab x
>     =  EReturn x
>     |  forall s . ELambda String (Tm {Head, s, Z} -> Elab x)
>     |  EGoal (TY -> Elab x)
>     |  EWait String TY (EXP -> Elab x)
>     |  ECry StackError 
>     |  EElab Loc EProb
>     |  ECompute (TY :>: Elab EXP) (EXP -> Elab x)
...
> instance (MonadError StackError) Elab where
>     throwError e           = ECry e
